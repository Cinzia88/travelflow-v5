...
class Preventive extends Model
{
    ...
    {
        return $this->belongsToMany(Email::class, 'email_preventive');
    }
    ...
    {
        if (!$this->numero_persone || !$this->numero_gratuita) {
            return;
        }
   ...
   */
        ...
        return [
            ...
            'icona' => $this->imageToBase64(public_path('pdf_images/icona.png')),
